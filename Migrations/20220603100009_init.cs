    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AlbumLocation", x => new { x.AlbumsAlbumId, x.LocationsId });
                    table.ForeignKey(
                        name: "FK_AlbumLocation_Albums_AlbumsAlbumId",
                        column: x => x.AlbumsAlbumId,
                        principalTable: "Albums",
                        principalColumn: "AlbumId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlbumLocation_Locations_LocationsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlbumLocation_LocationsId",
                table: "AlbumLocation",
                column: "LocationsId");
